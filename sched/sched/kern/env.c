...
env_alloc(struct Env **newenv_store, envid_t parent_id)
{
	...
	*newenv_store = e;
	...
	env_statistics.env_rans = 0;
	env_statistics.priority_boosts = 0;
	env_statistics.sched_calls = 0;
...
env_run(struct Env *e)
{
	...
	// Your code here
	if (!e) {
		// No hay un nuevo proceso.
		panic("env_run: no env to run\n");
	}
